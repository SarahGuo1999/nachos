...
#define PageSize  SectorSize 	// set the page size equal to  128
...
// Routines internal to the machine simulation -- DO NOT call these 
	...
	int MemoryAllocate();		// allocate memory for current thread
	void MemoryClear();			// clear memory for current thread
...
// the contents of the TLB are free to be modified by the kernel software.
	...
	int *LRUnum;   // record the using numer of tlb		
	unsigned long tlbMiss;   // tlb miss number
	unsigned long tlbHit;	   // tlb hit number
